...
def extractDates(sentences):
	...
	for i in range(len(sentences)):
		...
		complexDatePattern = re.compile(r"(?P<Date>[0-9]{1,2})(?P<ex>(st|th|nd|rd|st of|th of|nd of|rd of|of)*) (?P<Month>(January|February|March|April|May|June|July|August|September|October|November|December|Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec))(,*) (?P<Year>[0-9]{2,4})",re.IGNORECASE)
