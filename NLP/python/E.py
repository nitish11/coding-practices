...
def extractDates(sentences):
	...
	for i in range(len(sentences)):
		...
		for m in matchIter:
                ...
                complexDatePattern = re.compile(r"(?P<Date>[0-9]{1,2})(?P<ex>(st|th|nd|rd)*) (?P<Month>(January|February|March|April|May|June|July|August|September|October|November|December|Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec))(,*)(?P<exy>(st|th|nd|rd)*) (?P<Year>[0-9]{2,4})",re.IGNORECASE)
		...
		lcomplexDatePattern = re.compile(r"(?P<Date>[0-9]{1,2})(?P<ex>(st|th|nd|rd)*) of (?P<Month>(January|February|March|April|May|June|July|August|September|October|November|December|Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec))(,*)(?P<exy>(st|th|nd|rd)*) (?P<Year>[0-9]{2,4})",re.IGNORECASE)
